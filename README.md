...
For a real training loop showcasing most features, see [https://raw.githubusercontent.com/phantomsc2/leitwerk/main/examples/train_sc2_bot.py](examples/train_sc2_bot.py):
