...
def _parse_mapping_node(model: Mapping[str, object], prefix: SchemaPath) -> tuple[tuple[FieldSpec, ...], BuildFn]:
...
def _parse_mapping_entry(key: object, value: object, prefix: SchemaPath) -> tuple[str, tuple[FieldSpec, ...], BuildFn]:
